...
// A combo of adapter format, back buffer format, and windowed/fullscreen that
...
public:
	...
	mutable CD3DEnumErrors errors;  // TODO(kasicass): why need mutable here?
};
...
public:
	...
	// const WCHAR* mConfigDBFileName; // TODO(kasicass): need it?
