...
HRESULT CEffectStateManager::SetVertexShaderConstantI(UINT registerIdx, const int* data, UINT registerCount)
{
	CD3DDevice& device   = CD3DDevice::getInstance();
	IDirect3DDevice9& dx = device.getDevice();
	CRenderStats& stats  = device.getStats();
...
HRESULT CEffectStateManager::SetVertexShaderConstantB(UINT registerIdx, const BOOL* data, UINT registerCount)
{
	CD3DDevice& device   = CD3DDevice::getInstance();
	IDirect3DDevice9& dx = device.getDevice();
	CRenderStats& stats  = device.getStats();
